...
- (void)layoutTableViewCell {
    self.titleLabel.text = @"极客时间：从零开发一款iOS App教程";
    ...
    self.timeLabel.frame = CGRectMake(self.commentLabel.frame.origin.x + self.commentLabel.frame.size.width + 15, self.timeLabel.frame.origin.y, self.commentLabel.frame.size.width, self.timeLabel.frame.size.height);
